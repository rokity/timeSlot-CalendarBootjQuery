...
$("#center").fadeOut( function() {
  ...
  var d = new Date();
  var number_of_day=Date.getDaysInMonth(d.getFullYear(),Date.getMonthNumberFromName(months[number]));
  var first_day = new Date(d.getFullYear(), Date.getMonthNumberFromName(months[number]), 1).getDay()-1;
  if(first_day==-1)
  first_day=6;
